...
func (du *DiseaseUpdate) AddPatientIDs(ids ...int) *DiseaseUpdate {
	du.mutation.AddPatientIDs(ids...)
	return du
}

// AddPatients adds the patients edges to Patient.
func (du *DiseaseUpdate) AddPatients(p ...*Patient) *DiseaseUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return du.AddPatientIDs(ids...)
}
...
func (du *DiseaseUpdate) RemovePatientIDs(ids ...int) *DiseaseUpdate {
	du.mutation.RemovePatientIDs(ids...)
	return du
}

// RemovePatients removes patients edges to Patient.
func (du *DiseaseUpdate) RemovePatients(p ...*Patient) *DiseaseUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return du.RemovePatientIDs(ids...)
}
...
func (du *DiseaseUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := du.mutation.RemovedPatientsIDs(); len(nodes) > 0 {
	...
	if nodes := du.mutation.PatientsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   disease.PatientsTable,
...
// AddPatientIDs adds the patients edge to Patient by ids.
func (duo *DiseaseUpdateOne) AddPatientIDs(ids ...int) *DiseaseUpdateOne {
	duo.mutation.AddPatientIDs(ids...)
	return duo
}

// AddPatients adds the patients edges to Patient.
func (duo *DiseaseUpdateOne) AddPatients(p ...*Patient) *DiseaseUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return duo.AddPatientIDs(ids...)
}
...
// RemovePatientIDs removes the patients edge to Patient by ids.
func (duo *DiseaseUpdateOne) RemovePatientIDs(ids ...int) *DiseaseUpdateOne {
	duo.mutation.RemovePatientIDs(ids...)
	return duo
}

// RemovePatients removes patients edges to Patient.
func (duo *DiseaseUpdateOne) RemovePatients(p ...*Patient) *DiseaseUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return duo.RemovePatientIDs(ids...)
}
...
func (duo *DiseaseUpdateOne) sqlSave(ctx context.Context) (d *Disease, err error) {
	...
	if nodes := duo.mutation.RemovedPatientsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   disease.PatientsTable,
	...
	if nodes := duo.mutation.PatientsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   disease.PatientsTable,
