...
// was not loaded in eager-loading.
func (e GenderEdges) DentistsOrErr() ([]*Dentist, error) {
	if e.loadedTypes[1] {
...
// QueryDentists queries the dentists edge of the Gender.
func (ge *Gender) QueryDentists() *DentistQuery {
	return (&GenderClient{config: ge.config}).QueryDentists(ge)
}
